...
const Common=(props)=>{
	...
	return (
		...
		<h1><Typical steps={['Capture Your ' , 300 , 'Capture Your Moments With ' , 1000 ]} loop={Infinity}   className="hd" /></h1> <h1><strong className="brand-name">Photo Junction </strong></h1>
		<h2 className="my-3">
